...
export const parsePushNotificationPayload = (
  ...
  const payload: PushNotificationPayload = {
    ...
    ownerScopeId: readString(raw.ownerScopeId),
    relationType: readEnum(raw.relationType, [
      "DIRECT",
      "BED",
      "SPACE",
      "RELATED_FROM_BED",
    ...
    affectedPlantingIds: readStringArray(raw.affectedPlantingIds),
    growingSpaceId: readString(raw.growingSpaceId),
